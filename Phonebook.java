...
class Phone implements Serializable{
   ...
   public Phone(String w_date,String d_date,String detail) {
      this.w_date=w_date;
      this.d_date=d_date;
      this.detail =detail;
   }
...
public class Phonebook{
   public static void main(String[] args) throws Exception {
      ...
      HashMap<Integer,Phonebook> h = new HashMap< Integer, Phonebook>(); 
      ...
      while(true) {
         ...
         if(choice==1) {
            ...
            h.put(memNO,new Phone(w_date,d_date,detail)); 
            memNO++;
         }
         else if (choice==2) {
            ...
            Phonebook m = h.get(a);
               ...
               if(m!=null) {
                  if(b==1) {
                     ...
                     h.put(a,new Phonebook(m.getw_date(),d_date,m.getdetail())); 
                  }
                  if (b==2) {
                     System.out.print("내용:");
                     String detail = scanner.nextLine();
                     detail = scanner.nextLine();
                     h.put(a,new Phonebook(m.getw_date(),m.getd_date(),detail)); 
                  }
               }
               System.out.print("*******************************\n");
         }
